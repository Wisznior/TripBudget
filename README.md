...
- Jan zapłacił: 200 PLN
- Anna zapłaciła: 100 PLN
- Piotr zapłacił: 0 PLN

**Obliczenia:**
- Suma wydatków: 300 PLN
- Średni koszt: 300 / 3 = 100 PLN
- Bilans Jana: 200 - 100 = +100 PLN (wierzyciel)
- Bilans Anny: 100 - 100 = 0 PLN (rozliczona)
- Bilans Piotra: 0 - 100 = -100 PLN (dłużnik)
...
### Wdrożenie w chmurze (Railway.app)

Aplikacja zawiera pliki konfiguracyjne dla Railway:
- `Procfile` - definicja procesu webowego
...
5. Deploy automatycznie uruchomi się przy każdym pushu

Szczegółowe instrukcje: patrz `DEPLOYMENT_QUICK.md`
...
- Upewnij się, że baza danych istnieje: `createdb tripbudget_db`
...
### Problem: Błąd NBP API (kursy walut)
**Rozwiązanie:**
- System automatycznie używa kursu 1:1 jako fallback
- Sprawdź połączenie internetowe
- Sprawdź dostępność API: `http://api.nbp.pl/`

---

## Roadmap (przyszłe funkcjonalności)

- [ ] Eksport rozliczeń do PDF
- [ ] Powiadomienia email o nowych wydatkach
- [ ] Aplikacja mobilna (React Native)
- [ ] Wsparcie dla więcej walut
- [ ] Integracja z systemami płatności (PayPal, Revolut)
- [ ] Udostępnianie wycieczek przez link
- [ ] Import wydatków z pliku CSV/Excel
- [ ] Wielojęzyczność (i18n)
- [ ] Dark mode
- [ ] Historia zmian w wycieczce (audit log)
